...
public class OrderDAO extends DAO{
	...
	private final String GETTOTALROW="select count(*) cnt from Orders where id=? ";
	
	private final String LIST = "select orderNo,goodsNo,orderState,hopeDate,goodsTitle,goodsImage,categoryNo,orderPrice,dlvyCharge,id,optNo,optName,amount from( "
				+ " select rowNum rnum,orderNo,goodsNo,orderState,hopeDate,goodsTitle,goodsImage,categoryNo,orderPrice,dlvyCharge,id,optNo,optName,amount from("
					+ " select o.orderNo, o.goodsNo, o.orderState,  to_char(o.hopeDate,'yyyy-mm-dd') hopeDate,g.goodsTitle, g.goodsImage,g.categoryNo ,o.orderPrice, o.dlvyCharge, o.id,"
	...
	private String getAdminListSQL(PageObject pageObj) {
		String sql = " select  orderNo,goodsNo,orderState,hopeDate,goodsTitle,goodsPublicher,goodsPrice,goodsCost,goodsStatus,categoryNo,categoryName,orderPrice,dlvyCharge,id,name,memberTel,dlvyAddrNo,recipient,tel,addr,postNo,payWay,payDetail  from("
				+ " select rowNum rnum, orderNo,goodsNo,orderState,hopeDate,goodsTitle,goodsPublicher,goodsPrice,goodsCost,goodsStatus,categoryNo,categoryName,orderPrice,dlvyCharge,id,name,memberTel,dlvyAddrNo,recipient,tel,addr,postNo,payWay,payDetail from( "
				+ " select o.orderNo, o.goodsNo, o.orderState, to_char(o.hopeDate,'yyyy-mm-dd') hopeDate,g.goodsTitle, g.goodsPublicher , g.goodsPrice,g.goodsCost,g.goodsStatus,g.categoryNo , c.categoryName ,o.orderPrice, o.dlvyCharge, o.id,m.name,m.tel as memberTel, "
	...
	private final String VIEW = "select o.orderNo, o.goodsNo, o.orderState,o.hopeDate, o.payWay, o.payDetail,  g.goodsTitle, g.goodsImage,g.categoryNo ,o.orderPrice, o.dlvyCharge, o.id,"
