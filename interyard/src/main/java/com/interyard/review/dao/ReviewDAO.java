...
public class ReviewDAO extends DAO {
	...
	final String LIST = " select"
				+ " r.revNo, r.title, r.content, r.imgFile, r.grade, TO_CHAR(r.writeDate, 'yyyy-mm-dd') AS writeDate, r.id, "
				+ " m.name, r.likeCnt, r.ordNo, r.levNo, r.goodsNo, g.goodsTitle, r.orderNo,  r.parentNo, "
			...
			+ " where g.goodsNo = ? "
			+ " group by "
				+ " r.revNo, r.title, r.content, r.imgFile, r.grade, TO_CHAR(r.writeDate, 'yyyy-mm-dd'), r.id, "
				+ " m.name,  r.likeCnt, r.ordNo, r.levNo, r.goodsNo, g.goodsTitle, r.orderNo,  r.parentNo "
