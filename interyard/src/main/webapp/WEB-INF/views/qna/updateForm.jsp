					...
					<div class="form-group">
						...
						<c:if test="${qvo.levNo == 0 }">
							<select class="form-control  ml-2 mr-5" id="semiCtg" name="semiCtg" style="width:300px;">
								<option value="예약변경/취소" >주문/결제/입금확인</option>
								<option value="주문/결제/입금확인" >배송문의</option>
								<option value="배송지변경" >반품/교환/AS/환불</option>
								<option value="반품/교환/AS/환불" >이벤트/할인쿠폰</option>
