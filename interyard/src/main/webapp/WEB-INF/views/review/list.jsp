...
<c:if test="${!empty list }">
	<div class="p-3 mb-0 ">
		<div class="row">
			<div class="col-sm-6 p-2">
				<div style="text-align: center;">
					...
					<p>
						...
						<br> <span style="font-size: 28px;"><strong>${totalReview.avgReview }</strong></span>
			...
			<div class="col-sm-6 p-2">
				<div style="text-align: center;">
					<div style="text-align: center;">
						<span class="mb-3"><b>전체 리뷰 수</b></span><br> <i
	...
	<c:forEach items="${list }" var="vo">
		...
		>
			<img src="${(!empty login.photo)? login.photo : '/upload/image/noImage.png' }" alt="i"
