	...
	<form action="write.do" method="get" id="writeForm">	
		...
		<div class="border rounded p-3 mb-2 bg-white text-dark shadow-sm" id="dlvyPrintDiv">		
			...
			<c:if test="${list.get(0).isMultiOrder() }">
		  	...
		  	<input type="text" class="form-control my-3" id="dlvyMemo" name="dlvyMemo" placeholder="배송 메모를 입력해주세요.">			  			
			<c:if test="${list.get(0).isMultiOrder() }">
				<div id="eachDlvyMemoDiv">
				<!-- 주문 상품 만큼 배송메모 입력 태그 생성 -->
					<c:forEach items="${list }" var="vo">
						${vo.goodsTitle }				
			  			<input type="text" class="form-control my-3 eachDlvyMemo" name="dlvyMemo" placeholder="배송 메모를 입력해주세요.">			  			
		  			</c:forEach>
	  			</div>		
	 		</c:if>	  						
		</div>
			    ...
			    <div id="cardDetail" class="ml-3 my-2"> 			    	
			    	...
			    	<div class="form-inline my-2">				    	
	    					...
	    					<i class="fa fa-minus mx-2"></i>
	      					...
	      					<i class="fa fa-minus mx-2"></i>	    				
	      					<input type="text" class="form-control cardInput" maxlength="4" id="card3" name="card" placeholder="0000">	
	      					<i class="fa fa-minus mx-2"></i>	    				
	      					<input type="text" class="form-control cardInput" maxlength="4" id="card4" name="card" placeholder="0000">	    				    				
    				</div>
			    </div>
  			</div>
  			<div class="custom-control custom-radio my-2">
