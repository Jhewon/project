...
function checkedPriceAmount() {
	...
	$(".basketCheckBox:checked").each(function() {
		...
		totalCheckPrice += +(numWithoutComma($listItem.find(".orderPrice").text()));			
	});
	$("#totalCheckPrice").text(numWithComma(totalCheckPrice));
...
<div class="container">
	<nav class="navbar navbar-expand-sm navbar-dark fixed-bottom" style="background-color: black; height: 80px;">
		<div class="container text-white">
			<span class="ml-2">총 <b><span id="totalCheckAmount">0</span>건</b> 주문금액 <b style="font-size: 24px;"> <span id="totalCheckPrice">0</span>원</b></span>
				  		...
				  		<li class="list-group-item basketListItem" data-goodsNo="${vo.goodsNo }" data-basketno="${vo.basketNo }" data-categoryNo="${vo.categoryNo }">
				  			...
				  			<div class="row">
				  				...
				  				<div class="col-4">	 
				    				...
				    				<!-- 결제 금액 배송비 -->
				    				<h5><b class="orderPrice">${vo.orderPrice }</b> <small class="dlvyCharge">${vo.dlvyCharge }</small></h5>
