...
<form method="post" id="dlvyUpdateForm">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="selfInput" placeholder="배송지 별명을 입력해주세요">
	</div>
	<div class="form-group">
		<label for="recipient">받는 사람</label> 
		<input type="text" class="form-control" id="recipient" name="recipient" value="${vo.recipient }">
	</div>
	<div class="form-group">
